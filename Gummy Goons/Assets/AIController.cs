...
public class AIController : MonoBehaviour
{
    ...
    public float meshResolution = 1.0f;             //  how many rays are cast per degree when generating the mesh for the navigation mesh. A higher value will result in a more accurate mesh, but will also take longer to generate.
    public int edgeIterations = 4;                  //  Number of iterations to get a better performance of the mesh filter when the raycast hits an obstacle. Increasing this value can improve performance but may also decrease accuracy.
